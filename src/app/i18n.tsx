...
const STR: Record<string, { ru: string; en: string }> = {
  ...
  "soc.feedTitle":     { ru: "Пульс", en: "Pulse" },
  "soc.pulseSub":      { ru: "Люди, релизы и живые комнаты — в одном ритме", en: "People, releases and live rooms — in one rhythm" },
  "soc.liveNow":       { ru: "Сейчас в Пульсе", en: "Live in Pulse" },
