...
const STR: Record<string, { ru: string; en: string }> = {
  ...
  "act.cpActivated":  { ru: "Creator+ подключён", en: "Creator+ activated" },
  "act.cpCancelled":  { ru: "Creator+ отменён — доступ до конца периода", en: "Creator+ cancelled — access until the period ends" },
  "act.cpResumed":    { ru: "Подписка Creator+ возобновлена", en: "Creator+ subscription resumed" },
